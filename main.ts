      ...
      <div class="max-w-[1050px] mx-auto text-center">
        ...
        <div id="dashboard-header" class="hidden">
           <div class="bg-zinc-900/50 p-6 rounded-xl border border-zinc-800 mb-8 flex justify-between items-center text-left">
              <div><h2 class="text-yellow-500 font-black text-2xl uppercase italic">Member: <span id="displayUser" class="text-white"></span></h2><p class="text-zinc-500 text-xs font-bold mt-1 uppercase">Available Credits: <span id="displayCredits" class="bg-sky-900 text-sky-400 px-3 py-0.5 rounded ml-1">0</span></p></div>
